...
script=$woolzDir'WlzExtFFConstruct3D -o '$dirName'/wlz/0020.wlz -f '$dirName'/out/out.txt'
echo "Folder: "$dirName 
#echo "Script: " $script
$script
echo "Created woolz!"
...
cd $dirName/wlz/
script=$woolzDir"WlzThreshold -v1 0020.wlz"
echo "Theshold: " $script
#eval $script > ./0021.wlz

script=$woolzDir"WlzSetVoxelSize -x1 -y1 -z1.5 0020.wlz"
echo "Script4: " $script
eval $script > ./002.wlz
